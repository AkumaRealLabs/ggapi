...
type RelayInfo struct {
	...
	// ForcePreConsume marks asynchronous tasks that must reserve their full
	// estimate before submission. Wallet billing now always reserves before an
	// upstream request, so this remains as task metadata for compatibility.
