...
function ChatRouteComponent() {
  ...
  if (!preset) {
    return (
      <div className='flex h-full flex-col items-center justify-center p-6'>
        <div data-slot='sketch-chat-empty' className='max-w-md space-y-4'>
          <MessageCircleWarning className='text-muted-foreground mx-auto h-12 w-12' />
  ...
  if (requiresActiveKey && (isError || !activeKey || !iframeSrc)) {
    ...
    return (
      <div className='flex h-full flex-col items-center justify-center p-6'>
        <div data-slot='sketch-chat-empty' className='max-w-xl'>
