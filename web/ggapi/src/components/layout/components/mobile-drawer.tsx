    ...
    <AnimatePresence>
      {isOpen && (
        <>
          {/* Overlay */}
          <motion.div
            data-slot={MOBILE_DRAWER_CONFIG.overlayDataSlot}
          ...
          {/* Drawer Content */}
          <motion.div
            data-slot={MOBILE_DRAWER_CONFIG.drawerDataSlot}
          ...
          >
            <div className='flex flex-col gap-4'>
              ...
              <div
                data-slot='sketch-mobile-drawer-head'
