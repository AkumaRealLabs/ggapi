...
export function StaggerItem(props: StaggerItemProps) {
  const { children, className, variants: _variants, ...rest } = props
  return (
...
interface TableStaggerRowProps extends HTMLAttributes<HTMLTableRowElement> {
  children: ReactNode
  className?: string
  variants?: Variants
}

export function TableStaggerRow(props: TableStaggerRowProps) {
  const { children, className, variants: _variants, ...rest } = props
  return (
