...
export const ModelGroupSelector: React.FC<ModelGroupSelectorProps> = ({
  ...
  const renderTrigger = () => (
    <Button
      data-slot='sketch-model-selector-trigger'
      aria-expanded={open}
      className={cn(
  ...
  return isMobile ? (
    ...
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverContent
        data-slot='sketch-model-selector-panel'
        align='end'
        className={cn(
          'bg-popover z-50 w-[34rem] max-w-[calc(100vw-2rem)] rounded-xl border p-0 shadow-none',
