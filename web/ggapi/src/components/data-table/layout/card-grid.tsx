      ...
      {rows.map((row) => {
        ...
        return (
          <div
            ...
            className={cn(
              'rounded-lg border bg-(--data-table-card-bg,var(--table-row)) px-3.5 py-3 transition-[background-color,border-color] duration-150 data-[state=selected]:[--data-table-card-bg:color-mix(in_oklch,var(--sketch-blue,var(--primary))_10%,var(--table-row))] data-[state=selected]:border-[color-mix(in_oklch,var(--ink,var(--foreground))_55%,transparent)]',
