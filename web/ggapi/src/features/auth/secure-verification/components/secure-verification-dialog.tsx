    ...
    >
      {availableTabs.length === 0 ? (
        <div className='grid place-items-center gap-4 text-center'>
          <div
            data-slot='sketch-verify-icon'
            className='bg-muted flex h-16 w-16 items-center justify-center rounded-xl'
          >
        ...
        >
          ...
          <TabsContent value='passkey' className='space-y-4'>
            <div
              data-slot='sketch-verify-icon'
              className='bg-muted/50 flex items-center justify-center rounded-lg p-4'
            >
