...
import { ExplainerHome } from './components/explainer-home'
...
export function Home() {
  ...
  if (!isLoaded) {
    return (
      <div className='gg-explainer' data-slot='sketch-home'>
        <div
          className='container'
  ...
  // Admin-configured custom home (URL / HTML / markdown) still supported.
  if (content) {
    if (isUrl) {
      return (
  ...
  // Default product home: full tech-visual-explainer page (no PublicHeader SaaS chrome).
  return <ExplainerHome isAuthenticated={isAuthenticated} />
}
