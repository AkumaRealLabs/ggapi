...
export function PerformanceOverview() {
  ...
  if (!loading && !hasData) {
    return (
      <div
        data-slot='sketch-perf-bar'
        className='text-muted-foreground overflow-hidden rounded-lg border px-4 py-3 text-center text-xs'
      >
  ...
  return (
    <div data-slot='sketch-perf-bar' className='overflow-hidden rounded-lg border'>
