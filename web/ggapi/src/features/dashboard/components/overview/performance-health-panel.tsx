...
export function PerformanceHealthPanel() {
  ...
  return (
    <section
      data-slot='sketch-panel'
      className='bg-card h-full overflow-hidden rounded-xl border'
    >
      <div
        data-slot='sketch-panel-head'
...
function MetricCell(props: {
  ...
  return (
    <div data-slot='sketch-tile' className='bg-muted/40 rounded-xl px-3 py-2.5'>
