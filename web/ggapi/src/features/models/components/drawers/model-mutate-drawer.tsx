      ...
      >
        ...
        <Form {...form}>
          ...
          >
            ...
            <SideDrawerSection>
              <h3
                data-slot='sketch-drawer-section-title'
            ...
            <SideDrawerSection>
              <h3 data-slot='sketch-drawer-section-title' className='text-sm font-semibold'>{t('Matching Rules')}</h3>
            ...
            <SideDrawerSection>
              <div className='flex items-center justify-between'>
                <h3 data-slot='sketch-drawer-section-title' className='text-sm font-semibold'>{t('Endpoints')}</h3>
                <Select<string>
            ...
            <SideDrawerSection>
              <h3 data-slot='sketch-drawer-section-title' className='text-sm font-semibold'>
            ...
            {/* Status & Sync */}
            <SideDrawerSection>
              <h3 data-slot='sketch-drawer-section-title' className='text-sm font-semibold'>{t('Status & Sync')}</h3>
