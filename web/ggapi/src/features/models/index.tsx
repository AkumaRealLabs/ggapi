    ...
    <>
      <SectionPageLayout fixedContent>
        ...
        <SectionPageLayout.Content>
          <div
            data-slot='sketch-models-page'
            className='flex h-full min-h-0 flex-col gap-4'
          >
            <Tabs value={activeSection} onValueChange={handleSectionChange}>
              <TabsList
                data-slot='sketch-models-tabs'
                className='max-w-full flex-wrap justify-start group-data-horizontal/tabs:h-auto sm:group-data-horizontal/tabs:h-auto'
              >
