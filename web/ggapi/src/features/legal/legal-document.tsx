...
export function LegalDocument({
    ...
    return (
      <PublicLayout>
        <div
          ...
          className='mx-auto flex max-w-4xl flex-col gap-4 py-12'
        >
  ...
  if (!success || !hasContent) {
    return (
      <PublicLayout>
        <div data-slot='sketch-legal' className='mx-auto max-w-2xl py-12'>
          <Card data-slot='sketch-legal-card' className='border-dashed'>
            <CardHeader className='flex flex-row items-center gap-4'>
              <div
                data-slot='sketch-legal-icon'
  ...
  if (isUrl) {
    return (
      <PublicLayout>
        <div data-slot='sketch-legal' className='mx-auto max-w-2xl py-12'>
          <Card data-slot='sketch-legal-card'>
            <CardHeader>
  ...
  return (
    <PublicLayout showMainContainer={!contentIsHtml}>
      {contentIsHtml ? (
        ...
        <div
          data-slot='sketch-legal'
          className='mx-auto max-w-4xl space-y-6 py-12'
        >
          <div className='space-y-2'>
            <h1
              data-slot='sketch-legal-title'
          ...
          <div data-slot='sketch-legal-body'>
            <RichContent
              mode='markdown'
              content={rawContent}
