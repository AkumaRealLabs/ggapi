...
import { QUOTA_TYPE_VALUES, TOKEN_UNIT_LABEL } from '../constants'
...
function SectionTitle(props: {
  ...
  return (
    <div data-slot='sketch-section' className='mb-4'>
      <h2 data-slot='sketch-section-title' className='text-base font-semibold'>{props.children}</h2>
      {props.description && (
...
function OverviewSummaryGrid(props: { model: PricingModel }) {
  ...
  return (
    <div data-slot='sketch-panel' className='divide-border grid divide-y overflow-hidden rounded-xl border sm:grid-cols-3 sm:divide-x sm:divide-y-0'>
...
function ModelBackendQuickStats(props: { model: PricingModel }) {
  ...
  return (
    <div data-slot='sketch-panel' className='divide-border grid grid-cols-2 divide-x divide-y overflow-hidden rounded-xl border @md/details:grid-cols-3 @2xl/details:grid-cols-5'>
      {stats.map((stat) => {
...
function ModelBackendSignalsSection(props: { model: PricingModel }) {
  ...
  return (
    <section>
      ...
      <div data-slot='sketch-panel' className='space-y-4 rounded-xl border p-4'>
        {capabilities.length > 0 && (
          <CatalogPillList
        ...
        {(inputModalities.length > 0 || outputModalities.length > 0) && (
          <div className='grid gap-2 sm:grid-cols-2'>
            {inputModalities.length > 0 && (
              <div data-slot='sketch-tile' className='bg-muted/20 flex items-center justify-between gap-3 rounded-lg px-3 py-2.5'>
                <span className='text-muted-foreground text-xs font-medium'>
                  {t('Input')}
                </span>
                <CatalogTextValue>
...
function ModelBackendProviderSection(props: { model: PricingModel }) {
  ...
  return (
    <section>
      ...
      <div data-slot='sketch-panel' className='divide-border grid grid-cols-1 overflow-hidden rounded-xl border sm:grid-cols-2 [&>*]:border-b [&>*:nth-child(odd)]:sm:border-r [&>*:nth-last-child(-n+2)]:sm:border-b-0'>
        {cells}
      </div>
    </section>
  )
...
function ModelHeader(props: { model: PricingModel }) {
  ...
  return (
    <header data-slot='sketch-details-header' className='space-y-5'>
      <div className='flex items-start gap-4'>
        <div data-slot='sketch-model-icon' className='bg-muted flex size-12 shrink-0 items-center justify-center rounded-xl'>
          {modelIcon || (
    ...
    if (dynamicSummary.isSpecialExpression) {
      return (
        <section>
          ...
          <div data-slot='sketch-panel' className='border-warning/30 bg-warning/10 rounded-xl border p-4'>
    ...
    <PublicLayout showMainContainer={false}>
      <PageTransition className='mx-auto max-w-5xl px-4 pt-20 pb-16 sm:px-6 lg:px-8'>
        ...
        <ModelDetailsContent
          ...
          showRechargePrice={
            hasDistinctRechargePrice(priceRate ?? 1, usdExchangeRate ?? 1) &&
            (search.rechargePrice ?? false)
          }
          endpointMap={
