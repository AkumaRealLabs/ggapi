...
export function getMessageContentStyles() {
  return [
    ...
    // paper-sketch overrides via [data-slot=sketch-msg-user] when present.
...
/** Role-specific data-slot for paper-sketch message chrome */
export function getMessageContentDataSlot(
  role: 'user' | 'assistant' | string
): string {
  if (role === 'user') return 'sketch-msg-user'
  if (role === 'assistant') return 'sketch-msg-assistant'
  return 'sketch-msg-other'
}
