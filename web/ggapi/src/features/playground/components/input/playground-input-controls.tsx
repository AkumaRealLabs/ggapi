...
export function PlaygroundInputControls({
  ...
  const renderSubmitButton = () =>
    shouldShowStop ? (
      ...
      <PromptInputButton
        data-slot='sketch-send'
        className='bg-primary text-primary-foreground hover:bg-primary/90 disabled:bg-muted disabled:text-muted-foreground h-8 px-3 font-medium'
        disabled={!canSubmit}
        type='submit'
        variant='default'
      >
  ...
  return (
    <div
      data-slot='sketch-playground-controls'
      className='flex w-full flex-col gap-2.5 md:flex-row md:items-center md:justify-between'
    >
