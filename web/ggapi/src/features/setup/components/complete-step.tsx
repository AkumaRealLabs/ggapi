...
export function CompleteStep({ status, values }: CompleteStepProps) {
  ...
  return (
    <div
      data-slot='sketch-setup-complete'
      className='flex flex-col items-center gap-6 text-center'
    >
      <div
        data-slot='sketch-setup-complete-icon'
        className='bg-success/10 text-success rounded-xl p-4'
      >
      ...
      <div
        data-slot='sketch-setup-summary'
        className='bg-card w-full rounded-xl border p-6 text-left sm:p-8'
      >
