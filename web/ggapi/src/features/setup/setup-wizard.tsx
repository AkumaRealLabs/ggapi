...
export function SetupWizard() {
  ...
  return (
    <div data-slot='setup-shell' className='bg-muted/40 relative min-h-svh py-10'>
      ...
      <div className='container mx-auto flex max-w-5xl flex-col gap-8 px-4 sm:px-6'>
          ...
          <div className='relative h-12 w-12'>
            {systemConfigLoading ? (
              ...
              <img
                src={logo}
                alt={t('System logo')}
                data-slot='sketch-brand-mark' className='h-12 w-12 rounded-full object-cover'
              />
            )}
          </div>
          {systemConfigLoading ? (
        ...
        <Card data-slot='sketch-panel' className='shadow-none'>
