...
const settingsSwitchRowClassName =
  'flex min-w-0 flex-row items-center justify-between gap-4 border-b border-dashed border-[color-mix(in_oklch,var(--ink,var(--border))_25%,transparent)] py-2.5 last:border-b-0'

export function SettingsFormGrid(props: SettingsFormGridProps) {
  return (
    <div
      data-slot='settings-form-grid'
...
export function SettingsControlGroup({
  ...
  return (
    <div
      data-slot='settings-control-group'
      data-settings-form-span='full'
      className={cn(
