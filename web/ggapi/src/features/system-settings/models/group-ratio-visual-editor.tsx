...
const sectionCardClassName =
  'relative ring-0 border border-border/90 rounded-xl'
const sectionHeaderClassName = 'border-b bg-muted/20'
const sketchSectionProps = {
  'data-slot': 'sketch-ratio-section',
} as const
...
export const GroupRatioVisualEditor = memo(function GroupRatioVisualEditor({
  ...
  return (
    <div className='space-y-4' data-slot='sketch-ratio-editor'>
      <GroupPricingTable
      ...
      {/* Auto Groups */}
      <Card className={sectionCardClassName} {...sketchSectionProps}>
        <CardHeader
          className={sectionHeaderClassName}
          data-slot='sketch-ratio-head'
        >
...
function GroupPricingTable({
  ...
  return (
    <Card className={sectionCardClassName} data-slot='sketch-ratio-section'>
      <CardHeader
        className={sectionHeaderClassName}
        data-slot='sketch-ratio-head'
      >
