...
export function ProfileHeader({ profile, loading }: ProfileHeaderProps) {
  ...
  if (loading) {
    return (
      <Card data-card-hover='false' data-slot='sketch-panel' className='gap-0 overflow-hidden py-0'>
        ...
        <div data-slot='sketch-stat-rail' className='border-t'>
          <div className='grid grid-cols-3'>
            {['balance', 'usage', 'requests'].map((key) => (
              <div
                key={key}
                data-slot='sketch-wallet-stat'
  ...
  return (
    <Card data-card-hover='false' data-slot='sketch-panel' className='gap-0 overflow-hidden py-0'>
      <CardContent className='p-4 sm:p-5'>
        <div className='flex items-center gap-3 sm:gap-4'>
          <Avatar data-slot='sketch-brand-mark' className='size-12 rounded-xl text-base sm:size-14 sm:text-lg'>
            <AvatarFallback
