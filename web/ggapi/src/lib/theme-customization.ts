...
export const THEME_PRESETS = [
  ...
  {
    // tech-visual-explainer sketch template: paper canvas + ink + blue accent.
    // Swatches preview paper → ink blue (core module color in the design system).
    value: 'paper-sketch',
    name: 'Paper Sketch',
    swatches: ['oklch(0.977 0.0098 87.5)', 'oklch(0.551 0.1518 261)'],
  },
  {
 ...
 * - `hand` — sketch handwriting (LXGW WenKai + KaiTi fallbacks), used by
 *   the paper-sketch preset from tech-visual-explainer.
 */
export type ThemeFont = 'default' | 'sans' | 'serif' | 'hand'
...
export const DEFAULT_THEME_CUSTOMIZATION: ThemeCustomization = {
  // ggapi shell: paper-sketch is the product default (tech-visual-explainer).
  preset: 'paper-sketch',
  font: 'default',
  radius: 'default',
  scale: 'default',
