...
describe('API key group table cell', () => {
  test('renders both Auto markers and cross-group status when retry is enabled', () => {
  ...
  test('keeps static Auto markers but omits moving layers for reduced motion', () => {
    const { container } = render(
  ...
  test('keeps Auto visible and shows cross-group only when retry is enabled', () => {
    ...
    rerender(<CellHarness group='auto' shouldReduceMotion={false} />)
